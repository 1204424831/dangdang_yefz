...
<link href="../css/pop_cheat.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="../js/jquery-3.3.1.js"></script>

</head>
<body>
	<div class="head">
		<a href="http://www.dangdang.com"> <img src="../images/signin_logo.png" /></a>
		<div class="improve">
			<img src="../images/bz.jpg" width="178" height="61" />
		</div>
	</div>
					...
					<form action="" method="post">
						...
						<div id="J_loginCoreWrap" class="infro">
							...
							<div class="password" id="password_div">
								<span></span> <input class="pass" id="txtPassword" name="" type="password" />
							</div>
							<br /> <br />
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" src="" class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
